...
export default function TermosUso() {
  ...
  useEffect(() => {
    document.title = "Termos de Uso - Dente de Tubarao";
    document.querySelector('meta[name="description"]')?.setAttribute('content', "Termos de uso do site Dente de Tubarao. Informacoes sobre produtos, precos, pedidos, pagamentos e envios.");
  }, []);
